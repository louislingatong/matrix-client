...
function ProductView() {
  ...
  return (
    <Container>
      <Row>
        <Col>
          <h3>{product.name || (product.product && product.product.name)}</h3>
        </Col>
      </Row>
      <Row>
        <Col xs={12} sm={12} md={8}>
          <Card className="justify-content-center" style={{height: '93%'}}>
            <FaBox size={200} className="p-3 align-self-center"/>
          </Card>
        </Col>
